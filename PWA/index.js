...
const socket = io('https://test-5fdn.onrender.com:9000');
...
const apiUrl = 'https://test-shopping.onrender.com/api/shopping-lists';
...
async function shareList(event) {
  ...
  try {
    ...
    const shareResponse = await fetch(`https://test-shopping.onrender.com/api/shopping-lists/${listId}/share`, {
      method: 'POST',
      headers: {
...
async function displayShoppingLists() {
  ...
  try {
    const response = await fetch('https://test-shopping.onrender.com/api/shopping-lists', {
      headers: {
        'Authorization': `Bearer ${accessToken}`
      }
    });
    ...
    for (const list of shoppingLists) {
      ...
      const productsResponse = await fetch(`https://test-shopping.onrender.com/api/shopping-lists/${list._id}`, {
        headers: {
          'Authorization': `Bearer ${accessToken}`
        }
      });
...
async function saveListName(listId) {
  ...
  try {
    const response = await fetch(`https://test-shopping.onrender.com/api/shopping-lists/${listId}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${accessToken}`
...
async function deleteProduct(listId, productId) {
  try {
    const response = await fetch(`https://test-shopping.onrender.com/api/shopping-lists/${listId}/products/${productId}`, {
      method: 'DELETE',
      headers: {
        'Authorization': `Bearer ${accessToken}`
      }
...
async function deleteList(id) {
  try {
    const response = await fetch(`https://test-shopping.onrender.com/api/shopping-lists/${id}`, {
      method: 'DELETE',
      headers: {
        'Authorization': `Bearer ${accessToken}`
      }
...
async function addProduct(event) {
  ...
  try {
    const response = await fetch(`https://test-shopping.onrender.com/api/shopping-lists/${listId}/products`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${accessToken}`
...
async function addProductToList(product, listId) {
  try {
    const response = await fetch(`https://test-shopping.onrender.com/api/shopping-lists/${listId}/products/${product._id}`, {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${accessToken}`,
        'Content-Type': 'application/json'
...
document.getElementById('edit-product-form').addEventListener('submit', async function(event) {
  ...
  try {
    const response = await fetch(`https://test-shopping.onrender.com/api/products/${productId}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${accessToken}`
...
async function displayExistingProducts(userId, listId) {
  try {
    const response = await fetch(`https://test-shopping.onrender.com/api/users/${userId}/products`, {
      headers: {
        'Authorization': `Bearer ${accessToken}`
      }
    });
  ...
  try {
    ...
    const handleSubmit = async function(event) {
      ...
      try {
        ...
        const response = await fetch(`https://test-shopping.onrender.com/api/send-shopping-list/${listId}`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${accessToken}`
